...
def test_all_fixed_plans_are_backend_not_ready(make_collector):
    ...
    for plan_id in PLAN_IDS:
        ...
        assert plan["apply"] == {"backend": "not-ready", "accepts_user_input": False}
...
def test_snapshot_lock_and_keyring_preconditions_are_explicit(make_collector):
    ...
    assert "package-manager-active" in lock["unavailable_reasons"]
